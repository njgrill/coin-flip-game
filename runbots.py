...
# bot_scripts = ["simple_mle_estimation.py", "random_bot.py", "follow_wins.py", "switch_strat.py", "mle_estimation.py", "big_brain_estimation.py", "anti_mle_estimation.py", "agg_bot.py"]
bot_scripts = ["mle_estimation.py", "agg_bot.py"]
